...
체류시간 극대화 (매우 중요 - 반드시 모두 적용):
- 첫 1~2줄: 공감 유도 문장 ("요즘 OO 맛집 찾기 어렵지 않나요?", "비 오는 날 뜨끈한 국물이 당기더라고요")
- 서론 끝에 궁금증 유발 ("근데 이 집 진짜 대박인 게 뭐냐면요...")
- 본론 중간에 독자 질문 2개 이상 ("혹시 이 메뉴 드셔본 분?", "어떤 게 더 끌리세요?")
- 꿀팁/추천 조합 섹션으로 끝까지 읽게 유도
- 마무리에 다음 글 예고 ("다음엔 OO도 가볼 예정이에요!")
- 3문장 이상 이어지는 문단 금지 (1~2문장마다 줄바꿈)
- 사진 자리 사이에 감성 문장 삽입 (사진만 연속 나열 금지)
